...
import com.tpfinalap.peralta1983.Dto.DtoEducacion;
import com.tpfinalap.peralta1983.Entity.Educacion;
import com.tpfinalap.peralta1983.Security.Controller.Mensaje;
import com.tpfinalap.peralta1983.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody DtoEducacion dtoEducacion){
        ...
        if(StringUtils.isBlank(dtoEducacion.getNombreE()) || StringUtils.isBlank(dtoEducacion.getDescripcionE()))
